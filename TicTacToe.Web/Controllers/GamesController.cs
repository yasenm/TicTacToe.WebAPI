        ...
        public IHttpActionResult Play(PlayRequestDataModel request)
        {
            ...
            switch (gameResult)
            {
                ...
                case GameResult.WonByX:
                    ...
                    game.FirstPlayer.GamesWon++;
                    game.FirstPlayer.Score += 3;
                    game.SecondPlayer.GamesLost++;
                    game.SecondPlayer.Score -= 2;
                    this.data.SaveChanges();
                    break;
                case GameResult.WonByO:
                    game.State = GameState.WonByO;
                    game.SecondPlayer.GamesWon++;
                    game.SecondPlayer.Score += 3;
                    game.FirstPlayer.GamesLost++;
                    game.FirstPlayer.Score -= 2;
                    this.data.SaveChanges();
                    break;
                case GameResult.Draw:
                    game.State = GameState.Draw;
                    game.SecondPlayer.DrawGames++;
                    game.SecondPlayer.Score++;
                    game.FirstPlayer.DrawGames++;
